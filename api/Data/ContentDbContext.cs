...
public class ContentDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Item>(e =>
        {
            ...
            e.Property(i => i.BonusAc).HasColumnName("bonus_ac");
            e.Property(i => i.WeaponBaseDamage).HasColumnName("weapon_base_damage");
            e.Property(i => i.WeaponBonusDamage).HasColumnName("weapon_bonus_damage");
        ...
        modelBuilder.Entity<Mob>(e =>
        {
            ...
            e.Property(m => m.Atk).HasColumnName("atk");
            e.Property(m => m.AttackIsParryable).HasColumnName("attack_is_parryable");
            e.Property(m => m.AvoidanceDodge).HasColumnName("avoidance_dodge");
            e.Property(m => m.AvoidanceParry).HasColumnName("avoidance_parry");
            e.Property(m => m.AvoidanceRiposte).HasColumnName("avoidance_riposte");
            e.Property(m => m.Ac).HasColumnName("ac");
